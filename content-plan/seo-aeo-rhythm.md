...
- Verify regulatory claims against current official NRC, eCFR, DOT, and applicable Agreement State sources before publishing or refreshing regulated content.
...
## Recurring sequence
1. Regulatory accuracy audit of high-traffic, recently published, and regulation-specific pages.
...
## Current priority queue — 2026-08-10

### P0 — Regulatory corrections
1. **Package Receipt Survey Requirements** (`/package-receipt-survey-requirements-for-radioactive-material/`)
...
2. **RSO Qualifications** (`/radiation-safety-officer-qualifications-nrc-and-agreement-state-requirements/`)
...
3. Remove or soften service promises that conflict with MVP guardrails:
...
4. Verify the homepage NRC License Consulting link target. The live homepage currently points to `/radiation-license-consultant/`, while the indexed service page is `/radioactive-material-license-consulting/`; confirm redirect behavior or update the link.

### P2 — Planning hygiene
5. Correct outdated content-calendar titles for Maine, New Hampshire, and Vermont so they no longer say NRC regulates RAM in those states.
6. Repair malformed table cells in priorities 22–25 in `content-plan/content-calendar.md`.
7. Reconcile Phase 2/3 task-table statuses with later completion notes in `TASKS.md` (Bing setup and lead tracker are recorded as completed later in the file).

### P3 — Analytics-driven growth
8. Do not lock Priority 31+ until authenticated Search Console/Jetpack/Bing data can be reviewed. When available, prioritize:
...
9. If analytics remain unavailable after accuracy/QA work is cleared, the provisional next AEO topic is **sealed-source leak-test requirements and records**, followed by survey-meter calibration and radioactive-material inventory/recordkeeping.
